...
class ProvidentFundLoanPage extends StatefulWidget{
  Loan loan;
  ProvidentFundLoanPage(Loan value){
    loan = value;
  }
  ...
  State<StatefulWidget> createState() {
    ...
    return ProvidentFundLoanState(loan);
  }
}

class ProvidentFundLoanState extends State<ProvidentFundLoanPage>{
  Loan _loan;
  ProvidentFundLoanState(Loan value){
    _loan = value;
  }
...
//      ),
  ...
  void _showAmountPicker(BuildContext cxt){
    ...
    List<Widget> items4(int maxIndex){
    ...
    final picker3  = CupertinoPicker(itemExtent: 40,
      ...
      print(maxIndex);
        setState(() {
          ...
          num3 = position;
          _loan.amount = num3*10+num4+num5*0.1+num6*0.01;
        });
      },
      backgroundColor: Colors.white,
      children: items3,
